...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-background group/calendar rounded-xl p-3 [--cell-size:2.2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none text-[1.05rem] font-bold text-foreground",
          captionLayout === "label"
            ? ""
        ...
        weekday: cn(
          "text-muted-foreground/90 flex-1 select-none rounded-md text-[0.78rem] font-semibold tracking-wide",
