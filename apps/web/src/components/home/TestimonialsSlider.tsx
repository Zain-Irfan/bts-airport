...
const REVIEWS = [
  ...
  { name: "David Chen",        location: "Singapore",        rating: 5, date: "1 week ago",    text: "Used London Airport Taxi Services for a Gatwick transfer. Booking was simple, confirmation instant, and the executive car was superb. Will definitely use again on my next London trip." },
  ...
  { name: "Michael Adeyemi",   location: "Lagos, Nigeria",   rating: 5, date: "2 months ago",  text: "Every time I visit London for business I use London Airport Taxi Services. Punctual, reliable, professional. The corporate billing is very convenient for my company." },
  ...
  { name: "Robert Hayes",      location: "Edinburgh, UK",    rating: 5, date: "2 weeks ago",   text: "I've used many transfer services in London but London Airport Taxi Services is by far the best. The meet & greet service at Gatwick was seamless. 10/10 would recommend." },
  { name: "Fatima Al-Hassan",  location: "Dubai, UAE",       rating: 5, date: "1 week ago",    text: "Used London Airport Taxi Services during my London business trip. The executive saloon was pristine and the driver was very knowledgeable about London. Will book again without hesitation." },
  ...
  { name: "Claire Dubois",     location: "Paris, France",    rating: 5, date: "10 days ago",   text: "Came to London for a conference. London Airport Taxi Services picked me up from Stansted and dropped me right at the venue. Perfect timing, no stress at all. Excellent service." },
  { name: "Ahmed Khalil",      location: "Riyadh, Saudi",   rating: 5, date: "3 weeks ago",   text: "The chauffeur service was extraordinary. Very professional driver, amazing luxury car. I felt like a VIP the entire journey. London Airport Taxi Services exceeded all my expectations." },
  { name: "Lucy Patterson",    location: "Leeds, UK",        rating: 5, date: "1 month ago",   text: "Reliable, safe and affordable. Used London Airport Taxi Services three times now and every single experience has been perfect. My go-to taxi service whenever I'm in London." },
  ...
  { name: "Ben Foster",        location: "London, UK",       rating: 5, date: "1 week ago",    text: "Used the electric vehicle option — a fantastic Tesla. Super quiet, smooth ride and very eco-friendly. Great initiative by London Airport Taxi Services. Loved every second." },
  ...
  { name: "Sophie Laurent",    location: "Lyon, France",     rating: 5, date: "1 month ago",   text: "I travel to London frequently for work and London Airport Taxi Services is my only choice. Always on time, always professional. The fixed pricing means absolutely no bill shock." },
  ...
  { name: "Hannah Clarke",     location: "Oxford, UK",       rating: 5, date: "2 weeks ago",   text: "Perfect for early morning airport runs. Driver was cheerful at 4am, helped load the bags and the car was warm and comfortable. Highly recommend London Airport Taxi Services." },
];
