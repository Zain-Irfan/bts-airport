...
export default async function TaxiBookingAppPage() {
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="BTS-section-charcoal relative py-20 md:py-28">
        <div className="container mx-auto grid items-center gap-12 px-4 md:grid-cols-2">
          ...
          <div className="space-y-6">
            <span className="BTS-pill">Features</span>
      ...
      <section className="BTS-section-onyx relative py-20 md:py-28">
        <div className="container mx-auto grid items-center gap-12 px-4 md:grid-cols-2">
          <div className="space-y-6">
            <span className="BTS-pill">How it works</span>
            <h2 className="text-3xl font-bold tracking-tight text-[#F8F8F8] md:text-4xl">
            ...
            <ol className="space-y-4">
              {howItWorks.map((item, index) => (
                ...
                >
                  <span className="grid h-9 w-9 flex-shrink-0 place-items-center rounded-full border border-[rgba(192,192,192,0.35)] bg-[linear-gradient(135deg,rgba(192,192,192,0.15)_0%,rgba(45,45,51,0.7)_100%)] text-xs font-bold text-[#C0C0C0] shadow-[inset_0_1px_0_rgba(192,192,192,0.2)]">
                    {index + 1}
                  </span>
      ...
      <section className="BTS-section-charcoal relative py-20 md:py-28">
        <div className="container mx-auto max-w-3xl px-4 text-center">
          <span className="BTS-pill">Always reliable</span>
